			...
			<div class="grid grid-cols-2 gap-4">
				...
				<div class="col-span-2">
					<button
						...
						class="border-4 border-white w-full bg-white p-2 rounded-xl font-bold text-2xl text-black hover:text-white hover:bg-transparent transition mix-blend-lighten disabled:bg-gray-200 disabled:border-gray-200 disabled:text-black disabled:mix-blend-lighten"
					>
						Send
					</button>
				</div>
