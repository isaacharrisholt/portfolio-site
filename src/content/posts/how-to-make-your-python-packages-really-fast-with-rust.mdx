...
import carDash from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-0.jpg'
import maturinInit from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-1.png'
import maturinDevelop from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-2.png'
import tenthFib from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-3.png'
import twentiethFib from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-4.png'
import thirtiethFib from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-5.png'
import maturinDevelopRelease from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-6.png'
import thirtiethFibRelease from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-7.png'
import fiftiethFib from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-8.png'
import firstFib from '../../assets/images/how-to-make-your-python-packages-really-fast-with-rust/image-9.png'
...
<Image src={maturinInit} alt="A screenshot of a terminal showing the maturin init command." />
...
<Image src={maturinDevelop} alt="A screenshot of a terminal showing the maturin develop command." />
...
<Image src={tenthFib} alt="Results for the 10th Fibonacci number." />
...
<Image src={twentiethFib} alt="Results for the 20th Fibonacci number." />

20th fib number results. Image by author.

<Image src={thirtiethFib} alt="Results for the 30th Fibonacci number." />
...
<Image src={maturinDevelopRelease} alt="A screenshot of a terminal showing the maturin develop --release command." />

If we now benchmark our 30th fib number, we see that Rust now gives us a whopping _40
times_ speed improvement over Python!

<Image src={thirtiethFibRelease} alt="Results for the 30th Fibonacci number, optimised." />
...
<Image src={fiftiethFib} alt="Rust experiencing integer overflow on the 50th fib number." />
...
<Image src={firstFib} alt="Results for the 1st Fibonacci number." />
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/jlWhnrk8go0?si=eYrQEiICS2iMcg4-" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
