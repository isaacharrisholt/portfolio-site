...
[Quiffen](https://pypi.org/project/quiffen/) is a Python package for parsing QIF files and exporting the data in more useful formats, such as dictionaries or pandas DataFrames. Quiffen can be installed from the command line by running:
...
Also, if you have any questions, please feel free to send them to me on [**GitHub**](https://github.com/isaacharrisholt/) or connect with me on [**LinkedIn**](https://www.linkedin.com/in/isaac-harris-holt/)! I love writing about my projects so you might like to follow me on [**Medium**](https://isaacharrisholt.medium.com/) too.
...
**_That’s all for this one! I hope you enjoyed it, and any feedback is greatly appreciated!_**
