...
import laptopMagnifyingGlass from '../../assets/images/parsing-qif-files-to-retrieve-financial-data-with-python/image-0.jpg'

<Image src={laptopMagnifyingGlass} alt="" />
