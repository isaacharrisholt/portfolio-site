...
I saw some… interesting keyboards, and some quite cool ones, but none of them stood out to me as much as the [Ergodox EZ](https://ergodox-ez.com/). It was incredibly well-designed and looked like it could fit into anyone’s workflow, but I wasn’t sure I wanted to commit to the high price tag at the time.

It wasn’t until a few months later when I’d started spending a lot more of my days typing that I decided to go all in on the ergo lifestyle and bought a few new things like a new chair and a new pillow. I went back to look at the Ergodox EZ, having come to terms with the fact that it would be worth the price, and lo and behold, ZSA, the company behind the keyboard, had released something new! It was called the [Moonlander](https://www.zsa.io/moonlander) (presumably because it would look right at home on the S.S. Enterprise) and it was everything the Ergodox was and more. I watched a few reviews, contemplated my switches and then took the plunge.
...
ZSA also provide enough information to make use of the mounting points that are on the underside of each module, so you can build accessories for your Moonlander if you so desire, or you can buy a [tripod kit](https://www.zsa.io/moonlander/tripod-kit) to attach your keyboard to your chair!
...
Otherwise, thanks for reading! I hope you found this review at least somewhat insightful. If you want to chat to me about it, I’m on [Twitter](https://twitter.com/IsaacHarrisHolt) or you can email me at [isaac@isaacharrisholt.com](mailto:isaac@isaacharrisholt.com).
